...
const PMAA = {
  ...
  t: {
    ...
    sec_atlas_sub:      { fr: 'Cherchez par nom commun, scientifique ou propriété. 270 espèces documentées en français, anglais et kreyòl.',
                          en: 'Search by common name, scientific name or property. 270 species documented in French, English and Kreyòl.',
                          kr: 'Chèche pa non komen, syantifik oswa pwopriyete. 270 espès dokumenté an fransè, anglè ak kreyòl.' },
    ...
    btn_voir_tout:      { fr: 'Voir tous les 270 plantes →', en: 'View all 270 plants →', kr: 'Wè tout 270 plantes yo →' },
    ...
    /* Page hero subtitles */
    atlas_sub:          { fr: '270 espèces documentées du Grand Sud & Grand\'Anse — fiches trilingues avec photos, propriétés, cartes et modes de préparation',
                          en: '270 species documented in the Grand Sud & Grand\'Anse — trilingual sheets with photos, properties, maps and preparation methods',
                          kr: '270 espès dokumenté nan Gran Sid & Gran\'Anse — fich trileng ak foto, pwopriyete, kat ak fason preparasyon' },
  },
