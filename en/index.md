...
<head>
  ...
  <title>Atlas of Plants of Southern Haiti</title>
  ...
  <style>
    * { font-family: 'Inter', sans-serif; }
    ...
    ::-webkit-scrollbar-thumb { background: #2c5e3b; border-radius: 4px; }
    ::-webkit-scrollbar-thumb:hover { background: #1e4028; }
...
<body id="home" class="bg-gray-50 text-gray-800 antialiased flex flex-col min-h-screen">

  <!-- HEADER - English version -->
  <header class="bg-[#2c5e3b] text-white shadow-lg sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-20">
        ...
        <div class="flex-shrink-0 flex items-center gap-3 cursor-pointer"
          ...
          <i class="fa-solid fa-leaf text-3xl text-[#c5a059]"></i>
          <h1 class="font-black text-xl md:text-2xl tracking-tight">Haiti Plant Atlas</h1>
        </div>

        <!-- Language Switcher -->
        <div class="hidden md:flex items-center gap-3">
          <div class="bg-[#1e4028] rounded-lg p-1 flex gap-1 border border-[#c5a059]/30">
            <a href="{{ '/fr/' | relative_url }}" class="px-3 py-1.5 rounded-md text-sm font-bold hover:bg-[#c5a059]/20 transition">🇫🇷 FR</a>
            <a href="{{ '/en/' | relative_url }}" class="px-3 py-1.5 rounded-md text-sm font-bold bg-[#c5a059] text-[#1e4028]">🇬🇧 EN</a>
            <a href="{{ '/ht/' | relative_url }}" class="px-3 py-1.5 rounded-md text-sm font-bold hover:bg-[#c5a059]/20 transition">🇭🇹 HT</a>
          </div>

          <!-- Navigation Desktop -->
          <nav class="hidden lg:flex items-center gap-4 ml-6">
            <a href="#home" class="hover:text-[#c5a059] transition text-sm font-medium">Home</a>
            <a href="#data-hub" class="hover:text-[#c5a059] transition text-sm font-medium">Database</a>
            <a href="#resources-hub" class="hover:text-[#c5a059] transition text-sm font-medium">Resources</a>
            <a href="#mission" class="hover:text-[#c5a059] transition text-sm font-medium">Mission</a>
          </nav>
        </div>

        <!-- Mobile -->
        <div class="md:hidden flex items-center gap-2">
          <select id="mobileLang"
                  class="bg-[#1e4028] border border-[#c5a059] rounded-lg px-2 py-1 text-sm text-white"
                  onchange="window.location.href = this.value">
            <option value="{{ '/fr/' | relative_url }}">🇫🇷 FR</option>
            <option value="{{ '/en/' | relative_url }}" selected>🇬🇧 EN</option>
            <option value="{{ '/ht/' | relative_url }}">🇭🇹 HT</option>
          </select>

          <button id="mobile-menu-btn" class="outline-none text-white focus:outline-none p-2" type="button">
    ...
    <!-- Mobile Menu -->
    <div id="mobile-menu" class="hidden bg-[#1e4028] border-t border-[#c5a059]/30 pb-4 shadow-inner">
      <div class="px-4 py-2 space-y-2">
        <a href="#home" class="block px-4 py-3 hover:bg-[#2c5e3b] rounded-lg text-white">Home</a>
        <a href="#data-hub" class="block px-4 py-3 hover:bg-[#2c5e3b] rounded-lg text-white">Database</a>
        <a href="#resources-hub" class="block px-4 py-3 hover:bg-[#2c5e3b] rounded-lg text-white">Resources</a>
        <a href="#mission" class="block px-4 py-3 hover:bg-[#2c5e3b] rounded-lg text-white">Mission</a>
      </div>
    </div>
  </header>
  ...
  <!-- FOOTER -->
  <footer class="bg-gray-900 text-gray-400 py-12 text-center border-t-4 border-[#c5a059]">
    <div class="max-w-7xl mx-auto px-4">
      <div class="flex items-center justify-center gap-3 mb-6">
        <i class="fa-solid fa-leaf text-[#c5a059] text-3xl"></i>
        <h4 class="text-white text-2xl font-black tracking-wider">HAITI PLANT ATLAS</h4>
      </div>
      <p class="mb-4 max-w-2xl mx-auto">Documentation, conservation and valorization of the biodiversity of Southern Haiti.</p>
      <div class="border-t border-gray-800 pt-6 mt-6 text-sm text-gray-500">
        <p>© 2026 Haiti Botanical Atlas. All rights reserved.</p>
      </div>
    </div>
  </footer>

  <!-- PLANT DETAIL MODAL -->
  <div id="plantModal" class="fixed inset-0 z-[100] hidden items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
    <div class="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto relative animate-fade-in">
      <button onclick="closeModal()" class="absolute top-4 right-4 bg-white hover:bg-gray-100 rounded-full w-10 h-10 flex items-center justify-center shadow-lg z-10" type="button">
      ...
      <div class="h-64 w-full relative">
        ...
        <div class="absolute bottom-0 left-0 p-6 text-white">
          <span id="modalFamille" class="text-xs font-bold text-[#c5a059] uppercase bg-black/30 px-2 py-1 rounded"></span>
          <h2 id="modalNomSci" class="text-3xl font-bold italic mt-2"></h2>
          <p id="modalNomCom" class="text-lg"></p>
        </div>
      </div>
      <div class="p-6 grid md:grid-cols-2 gap-6">
        <div>
          <h4 class="font-bold text-gray-500 uppercase text-sm mb-2">System</h4>
          <p id="modalSysteme" class="text-gray-800"></p>
        </div>
        <div>
          <h4 class="font-bold text-gray-500 uppercase text-sm mb-2">Diseases</h4>
          <p id="modalMaladie" class="text-gray-800"></p>
        </div>
        <div class="md:col-span-2">
          <h4 class="font-bold text-gray-500 uppercase text-sm mb-2">Use</h4>
          <p id="modalUtilisation" class="text-gray-800"></p>
        </div>
      </div>
    </div>
  </div>

  <!-- JavaScript (corrigé: assets/js) -->
  <script src="{{ '/assets/js/plantes-data.js' | relative_url }}" defer></script>
  <script src="{{ '/assets/js/ressources-data.js' | relative_url }}" defer></script>
